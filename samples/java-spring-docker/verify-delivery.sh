...
AOT_SCENARIO_DIR="${AOT_SCENARIO_DIR:-$BENCH_ROOT/04-jep483-aot-cache}"
...
echo "    cat benchmarks/04-jep483-aot-cache/AOT-CACHE-GUIDE.md"
echo ""
...
echo "    cat benchmarks/04-jep483-aot-cache/results/raw.csv"
echo ""
echo "=========================================="
...
echo "  → benchmarks/04-jep483-aot-cache/README.md"
echo ""
echo "Deep Dive Learning:"
echo "  → benchmarks/04-jep483-aot-cache/AOT-CACHE-GUIDE.md"
echo ""
echo "Project Overview:"
echo "  → benchmarks/README.md"
echo "  → benchmarks/04-jep483-aot-cache/AOT-DOCS-INDEX.md"
echo ""
echo "Documentation Index:"
echo "  → benchmarks/04-jep483-aot-cache/AOT-DOCS-INDEX.md"
echo ""
...
echo "  ✅ Canonical AOT benchmark scenario (04-jep483-aot-cache)"
